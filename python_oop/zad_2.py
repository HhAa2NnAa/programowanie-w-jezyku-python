...
lib1 = Library("Gdańsk", "Wita Stwosza 53", "80-308",
               "08:00-20:00", "58-111-22-33")
lib2 = Library("Wejherowo", "Kasztelanowa 26", "85-974",
               "10:00-18:00", "58-968-57-04")

emp1 = Employee("Kwiryniusz", "Mruczysław", "1990-09-06",
                "1954-09-11", "Gdańsk", "Długa 58",
                "80-407", "589-689-326")
emp2 = Employee("Marek", "Cwaniak", "2019-08-29",
                "1975-12-12", "Gdynia", "Rozmarynowa 190",
                "87-356", "436-257-866")
emp3 = Employee("Wacław", "Mądry", "2024-11-07",
                "1997-08-30", "Kartuzy", "Wilcza 176",
                "89-124", "846-379-982")
